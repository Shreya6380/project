  ...
  class signUpMethods {
    ...
    static authRedirecting() {
      window.setTimeout(() => {
        window.location.replace('https://deft-macaron-012058.netlify.app/client-side.html'); 
      }, 500)
    }
    ...
    firebaseAuthRedirect(){
      firebase.auth().onAuthStateChanged(function(user) {
        ...
        user ?  window.location.replace('https://deft-macaron-012058.netlify.app/client-side.html') : console.log('none');
      });
    }
  }
       ...
       logout.forEach(btn => {
         btn.addEventListener('click', (e) => {
           ...
           firebase.auth().signOut().then(() => {
            window.location.replace("https://deft-macaron-012058.netlify.app/index.html");
           });
         });
       })
     }
